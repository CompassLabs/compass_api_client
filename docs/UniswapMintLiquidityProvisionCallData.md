...
uniswap_mint_liquidity_provision_call_data_instance = UniswapMintLiquidityProvisionCallData.from_json(json)
# print the JSON string representation of the object
print(UniswapMintLiquidityProvisionCallData.to_json())

# convert the object into a dict
uniswap_mint_liquidity_provision_call_data_dict = uniswap_mint_liquidity_provision_call_data_instance.to_dict()
# create an instance of UniswapMintLiquidityProvisionCallData from a dict
uniswap_mint_liquidity_provision_call_data_from_dict = UniswapMintLiquidityProvisionCallData.from_dict(uniswap_mint_liquidity_provision_call_data_dict)
```
