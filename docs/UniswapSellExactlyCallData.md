...
json = "{}"
# create an instance of UniswapSellExactlyCallData from a JSON string
uniswap_sell_exactly_call_data_instance = UniswapSellExactlyCallData.from_json(json)
# print the JSON string representation of the object
print(UniswapSellExactlyCallData.to_json())

# convert the object into a dict
uniswap_sell_exactly_call_data_dict = uniswap_sell_exactly_call_data_instance.to_dict()
# create an instance of UniswapSellExactlyCallData from a dict
uniswap_sell_exactly_call_data_from_dict = UniswapSellExactlyCallData.from_dict(uniswap_sell_exactly_call_data_dict)
```
