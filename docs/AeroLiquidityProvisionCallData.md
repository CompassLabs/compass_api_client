# AeroLiquidityProvisionCallData
...
```python
from compass.api_client.models.aero_liquidity_provision_call_data import AeroLiquidityProvisionCallData

# TODO update the JSON string below
json = "{}"
# create an instance of AeroLiquidityProvisionCallData from a JSON string
aero_liquidity_provision_call_data_instance = AeroLiquidityProvisionCallData.from_json(json)
# print the JSON string representation of the object
print(AeroLiquidityProvisionCallData.to_json())

# convert the object into a dict
aero_liquidity_provision_call_data_dict = aero_liquidity_provision_call_data_instance.to_dict()
# create an instance of AeroLiquidityProvisionCallData from a dict
aero_liquidity_provision_call_data_from_dict = AeroLiquidityProvisionCallData.from_dict(aero_liquidity_provision_call_data_dict)
```
