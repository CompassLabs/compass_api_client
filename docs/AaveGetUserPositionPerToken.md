...
json = "{}"
# create an instance of AaveGetUserPositionPerToken from a JSON string
aave_get_user_position_per_token_instance = AaveGetUserPositionPerToken.from_json(json)
# print the JSON string representation of the object
print(AaveGetUserPositionPerToken.to_json())

# convert the object into a dict
aave_get_user_position_per_token_dict = aave_get_user_position_per_token_instance.to_dict()
# create an instance of AaveGetUserPositionPerToken from a dict
aave_get_user_position_per_token_from_dict = AaveGetUserPositionPerToken.from_dict(aave_get_user_position_per_token_dict)
```
