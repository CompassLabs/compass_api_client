...
json = "{}"
# create an instance of AaveBorrowCallData from a JSON string
aave_borrow_call_data_instance = AaveBorrowCallData.from_json(json)
# print the JSON string representation of the object
print(AaveBorrowCallData.to_json())

# convert the object into a dict
aave_borrow_call_data_dict = aave_borrow_call_data_instance.to_dict()
# create an instance of AaveBorrowCallData from a dict
aave_borrow_call_data_from_dict = AaveBorrowCallData.from_dict(aave_borrow_call_data_dict)
```
