...
class TestGetEnsDetailsRequest(unittest.TestCase):
    """GetEnsDetailsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEnsDetailsRequest:
        """Test GetEnsDetailsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEnsDetailsRequest`
        """
    ...
    def testGetEnsDetailsRequest(self):
        """Test GetEnsDetailsRequest"""
