...
class TestPriceRequest(unittest.TestCase):
    """PriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriceRequest:
        """Test PriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriceRequest`
        """
        model = PriceRequest()
        if include_optional:
            return PriceRequest(
