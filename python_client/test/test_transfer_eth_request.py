...
class TestTransferEthRequest(unittest.TestCase):
    """TransferEthRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferEthRequest:
        """Test TransferEthRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferEthRequest`
        """
    ...
    def testTransferEthRequest(self):
        """Test TransferEthRequest"""
