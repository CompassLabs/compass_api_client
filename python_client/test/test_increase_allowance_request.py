...
class TestIncreaseAllowanceRequest(unittest.TestCase):
    """IncreaseAllowanceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncreaseAllowanceRequest:
        """Test IncreaseAllowanceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncreaseAllowanceRequest`
        """
    ...
    def testIncreaseAllowanceRequest(self):
        """Test IncreaseAllowanceRequest"""
