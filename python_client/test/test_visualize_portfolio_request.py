...
class TestVisualizePortfolioRequest(unittest.TestCase):
    """VisualizePortfolioRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VisualizePortfolioRequest:
        """Test VisualizePortfolioRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VisualizePortfolioRequest`
        """
    ...
    def testVisualizePortfolioRequest(self):
        """Test VisualizePortfolioRequest"""
