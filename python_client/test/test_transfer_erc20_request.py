...
class TestTransferERC20Request(unittest.TestCase):
    """TransferERC20Request unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferERC20Request:
        """Test TransferERC20Request
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferERC20Request`
        """
    ...
    def testTransferERC20Request(self):
        """Test TransferERC20Request"""
