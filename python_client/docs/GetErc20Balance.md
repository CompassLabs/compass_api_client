...
json = "{}"
# create an instance of GetErc20Balance from a JSON string
get_erc20_balance_instance = GetErc20Balance.from_json(json)
# print the JSON string representation of the object
print(GetErc20Balance.to_json())

# convert the object into a dict
get_erc20_balance_dict = get_erc20_balance_instance.to_dict()
# create an instance of GetErc20Balance from a dict
get_erc20_balance_from_dict = GetErc20Balance.from_dict(get_erc20_balance_dict)
```
