# compass.api_client.UniversalApi

All URIs are relative to *https://api.compasslabs.ai*

Method | HTTP request | Description
------------- | ------------- | -------------
[**generic_allowance**](UniversalApi.md#generic_allowance) | **POST** /v0/generic/allowance/get | Get allowance - Protocol
[**generic_allowance_set**](UniversalApi.md#generic_allowance_set) | **POST** /v0/generic/allowance/set | Set Allowance - Protocol
[**generic_balance**](UniversalApi.md#generic_balance) | **POST** /v0/generic/balance/get | User token balance
[**generic_ens**](UniversalApi.md#generic_ens) | **POST** /v0/generic/ens/get | Resolve ENS
[**generic_portfolio**](UniversalApi.md#generic_portfolio) | **POST** /v0/generic/portfolio/get | List user portfolio
[**generic_price_usd**](UniversalApi.md#generic_price_usd) | **POST** /v0/generic/price/usd/get | Token price
[**generic_supported_tokens**](UniversalApi.md#generic_supported_tokens) | **POST** /v0/generic/supported_tokens/get | List supported tokens
[**generic_transfer_erc20**](UniversalApi.md#generic_transfer_erc20) | **POST** /v0/generic/transfer/erc20 | Transfer Token
[**generic_transfer_native_token**](UniversalApi.md#generic_transfer_native_token) | **POST** /v0/generic/transfer/native_token | Transfer ETH
[**generic_unwrap_weth**](UniversalApi.md#generic_unwrap_weth) | **POST** /v0/generic/unwrap_weth | Unwrap WETH
[**generic_visualize_portfolio**](UniversalApi.md#generic_visualize_portfolio) | **POST** /v0/generic/visualize_portfolio/get | Visualize user portfolio
[**generic_wrap_eth**](UniversalApi.md#generic_wrap_eth) | **POST** /v0/generic/wrap_eth | Wrap ETH
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = compass.api_client.UniversalApi(api_client)
    ...
    try:
        ...
        print("The response of UniversalApi->generic_allowance:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_allowance: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_allowance_set:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_allowance_set: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_balance:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_balance: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_ens:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_ens: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_portfolio:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_portfolio: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_price_usd:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_price_usd: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_supported_tokens:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_supported_tokens: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_transfer_erc20:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_transfer_erc20: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_transfer_native_token:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_transfer_native_token: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_unwrap_weth:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_unwrap_weth: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_visualize_portfolio:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_visualize_portfolio: %s\n" % e)
```
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UniversalApi->generic_wrap_eth:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UniversalApi->generic_wrap_eth: %s\n" % e)
```
