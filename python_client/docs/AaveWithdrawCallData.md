...
json = "{}"
# create an instance of AaveWithdrawCallData from a JSON string
aave_withdraw_call_data_instance = AaveWithdrawCallData.from_json(json)
# print the JSON string representation of the object
print(AaveWithdrawCallData.to_json())

# convert the object into a dict
aave_withdraw_call_data_dict = aave_withdraw_call_data_instance.to_dict()
# create an instance of AaveWithdrawCallData from a dict
aave_withdraw_call_data_from_dict = AaveWithdrawCallData.from_dict(aave_withdraw_call_data_dict)
```
