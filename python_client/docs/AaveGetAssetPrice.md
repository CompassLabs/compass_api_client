...
json = "{}"
# create an instance of AaveGetAssetPrice from a JSON string
aave_get_asset_price_instance = AaveGetAssetPrice.from_json(json)
# print the JSON string representation of the object
print(AaveGetAssetPrice.to_json())

# convert the object into a dict
aave_get_asset_price_dict = aave_get_asset_price_instance.to_dict()
# create an instance of AaveGetAssetPrice from a dict
aave_get_asset_price_from_dict = AaveGetAssetPrice.from_dict(aave_get_asset_price_dict)
```
