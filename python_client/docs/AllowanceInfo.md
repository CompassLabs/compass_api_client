...
json = "{}"
# create an instance of AllowanceInfo from a JSON string
allowance_info_instance = AllowanceInfo.from_json(json)
# print the JSON string representation of the object
print(AllowanceInfo.to_json())

# convert the object into a dict
allowance_info_dict = allowance_info_instance.to_dict()
# create an instance of AllowanceInfo from a dict
allowance_info_from_dict = AllowanceInfo.from_dict(allowance_info_dict)
```
