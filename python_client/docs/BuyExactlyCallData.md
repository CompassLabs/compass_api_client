...
json = "{}"
# create an instance of BuyExactlyCallData from a JSON string
buy_exactly_call_data_instance = BuyExactlyCallData.from_json(json)
# print the JSON string representation of the object
print(BuyExactlyCallData.to_json())

# convert the object into a dict
buy_exactly_call_data_dict = buy_exactly_call_data_instance.to_dict()
# create an instance of BuyExactlyCallData from a dict
buy_exactly_call_data_from_dict = BuyExactlyCallData.from_dict(buy_exactly_call_data_dict)
```
