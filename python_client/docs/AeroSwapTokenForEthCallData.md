...
```python
from compass.api_client.models.aero_swap_token_for_eth_call_data import AeroSwapTokenForEthCallData

# TODO update the JSON string below
json = "{}"
# create an instance of AeroSwapTokenForEthCallData from a JSON string
aero_swap_token_for_eth_call_data_instance = AeroSwapTokenForEthCallData.from_json(json)
# print the JSON string representation of the object
print(AeroSwapTokenForEthCallData.to_json())

# convert the object into a dict
aero_swap_token_for_eth_call_data_dict = aero_swap_token_for_eth_call_data_instance.to_dict()
# create an instance of AeroSwapTokenForEthCallData from a dict
aero_swap_token_for_eth_call_data_from_dict = AeroSwapTokenForEthCallData.from_dict(aero_swap_token_for_eth_call_data_dict)
```
