...
get_token_price_instance = GetTokenPrice.from_json(json)
# print the JSON string representation of the object
print(GetTokenPrice.to_json())

# convert the object into a dict
get_token_price_dict = get_token_price_instance.to_dict()
# create an instance of GetTokenPrice from a dict
get_token_price_from_dict = GetTokenPrice.from_dict(get_token_price_dict)
```
