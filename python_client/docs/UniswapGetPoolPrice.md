...
json = "{}"
# create an instance of UniswapGetPoolPrice from a JSON string
uniswap_get_pool_price_instance = UniswapGetPoolPrice.from_json(json)
# print the JSON string representation of the object
print(UniswapGetPoolPrice.to_json())

# convert the object into a dict
uniswap_get_pool_price_dict = uniswap_get_pool_price_instance.to_dict()
# create an instance of UniswapGetPoolPrice from a dict
uniswap_get_pool_price_from_dict = UniswapGetPoolPrice.from_dict(uniswap_get_pool_price_dict)
```
