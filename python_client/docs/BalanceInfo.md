...
json = "{}"
# create an instance of BalanceInfo from a JSON string
balance_info_instance = BalanceInfo.from_json(json)
# print the JSON string representation of the object
print(BalanceInfo.to_json())

# convert the object into a dict
balance_info_dict = balance_info_instance.to_dict()
# create an instance of BalanceInfo from a dict
balance_info_from_dict = BalanceInfo.from_dict(balance_info_dict)
```
