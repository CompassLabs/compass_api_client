...
json = "{}"
# create an instance of AaveGetLiquidityChange from a JSON string
aave_get_liquidity_change_instance = AaveGetLiquidityChange.from_json(json)
# print the JSON string representation of the object
print(AaveGetLiquidityChange.to_json())

# convert the object into a dict
aave_get_liquidity_change_dict = aave_get_liquidity_change_instance.to_dict()
# create an instance of AaveGetLiquidityChange from a dict
aave_get_liquidity_change_from_dict = AaveGetLiquidityChange.from_dict(aave_get_liquidity_change_dict)
```
