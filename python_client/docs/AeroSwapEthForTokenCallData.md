...
json = "{}"
# create an instance of AeroSwapEthForTokenCallData from a JSON string
aero_swap_eth_for_token_call_data_instance = AeroSwapEthForTokenCallData.from_json(json)
# print the JSON string representation of the object
print(AeroSwapEthForTokenCallData.to_json())

# convert the object into a dict
aero_swap_eth_for_token_call_data_dict = aero_swap_eth_for_token_call_data_instance.to_dict()
# create an instance of AeroSwapEthForTokenCallData from a dict
aero_swap_eth_for_token_call_data_from_dict = AeroSwapEthForTokenCallData.from_dict(aero_swap_eth_for_token_call_data_dict)
```
