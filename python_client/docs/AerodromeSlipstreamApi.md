...
------------- | ------------- | -------------
[**buy_exactly_v0_aerodrome_slipstream_swap_buy_exactly_post**](AerodromeSlipstreamApi.md#buy_exactly_v0_aerodrome_slipstream_swap_buy_exactly_post) | **POST** /v0/aerodrome_slipstream/swap/buy_exactly | Swap - into specified amount
[**get_pool_price_v0_aerodrome_slipstream_pool_price_get_post**](AerodromeSlipstreamApi.md#get_pool_price_v0_aerodrome_slipstream_pool_price_get_post) | **POST** /v0/aerodrome_slipstream/pool_price/get | Pool price
[**get_positions_v0_aerodrome_slipstream_liquidity_provision_positions_get_post**](AerodromeSlipstreamApi.md#get_positions_v0_aerodrome_slipstream_liquidity_provision_positions_get_post) | **POST** /v0/aerodrome_slipstream/liquidity_provision/positions/get | List LP positions
[**increase_v0_aerodrome_slipstream_liquidity_provision_increase_post**](AerodromeSlipstreamApi.md#increase_v0_aerodrome_slipstream_liquidity_provision_increase_post) | **POST** /v0/aerodrome_slipstream/liquidity_provision/increase | Increase an LP position
[**mint_v0_aerodrome_slipstream_liquidity_provision_mint_post**](AerodromeSlipstreamApi.md#mint_v0_aerodrome_slipstream_liquidity_provision_mint_post) | **POST** /v0/aerodrome_slipstream/liquidity_provision/mint | Open a new LP position
[**sell_exactly_v0_aerodrome_slipstream_swap_sell_exactly_post**](AerodromeSlipstreamApi.md#sell_exactly_v0_aerodrome_slipstream_swap_sell_exactly_post) | **POST** /v0/aerodrome_slipstream/swap/sell_exactly | Swap - from specified amount
[**withdraw_v0_aerodrome_slipstream_liquidity_provision_withdraw_post**](AerodromeSlipstreamApi.md#withdraw_v0_aerodrome_slipstream_liquidity_provision_withdraw_post) | **POST** /v0/aerodrome_slipstream/liquidity_provision/withdraw | Withdraw an LP position


# **buy_exactly_v0_aerodrome_slipstream_swap_buy_exactly_post**
> UnsignedTransaction buy_exactly_v0_aerodrome_slipstream_swap_buy_exactly_post(aerodrome_slipstream_buy_exactly_request)
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Swap - into specified amount
        api_response = api_instance.buy_exactly_v0_aerodrome_slipstream_swap_buy_exactly_post(aerodrome_slipstream_buy_exactly_request)
        print("The response of AerodromeSlipstreamApi->buy_exactly_v0_aerodrome_slipstream_swap_buy_exactly_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AerodromeSlipstreamApi->buy_exactly_v0_aerodrome_slipstream_swap_buy_exactly_post: %s\n" % e)
```
...
# **get_pool_price_v0_aerodrome_slipstream_pool_price_get_post**
> AerodromeSlipstreamPoolPriceResponse get_pool_price_v0_aerodrome_slipstream_pool_price_get_post(aerodrome_slipstream_get_pool_price_request)
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Pool price
        api_response = api_instance.get_pool_price_v0_aerodrome_slipstream_pool_price_get_post(aerodrome_slipstream_get_pool_price_request)
        print("The response of AerodromeSlipstreamApi->get_pool_price_v0_aerodrome_slipstream_pool_price_get_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AerodromeSlipstreamApi->get_pool_price_v0_aerodrome_slipstream_pool_price_get_post: %s\n" % e)
```
...
# **get_positions_v0_aerodrome_slipstream_liquidity_provision_positions_get_post**
> AerodromeLPPositionsResponse get_positions_v0_aerodrome_slipstream_liquidity_provision_positions_get_post(aerodrome_slipstream_get_liquidity_provision_positions_request)
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List LP positions
        api_response = api_instance.get_positions_v0_aerodrome_slipstream_liquidity_provision_positions_get_post(aerodrome_slipstream_get_liquidity_provision_positions_request)
        print("The response of AerodromeSlipstreamApi->get_positions_v0_aerodrome_slipstream_liquidity_provision_positions_get_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AerodromeSlipstreamApi->get_positions_v0_aerodrome_slipstream_liquidity_provision_positions_get_post: %s\n" % e)
```
...
# **increase_v0_aerodrome_slipstream_liquidity_provision_increase_post**
> UnsignedTransaction increase_v0_aerodrome_slipstream_liquidity_provision_increase_post(aerodrome_slipstream_increase_liquidity_provision_request)
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Increase an LP position
        api_response = api_instance.increase_v0_aerodrome_slipstream_liquidity_provision_increase_post(aerodrome_slipstream_increase_liquidity_provision_request)
        print("The response of AerodromeSlipstreamApi->increase_v0_aerodrome_slipstream_liquidity_provision_increase_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AerodromeSlipstreamApi->increase_v0_aerodrome_slipstream_liquidity_provision_increase_post: %s\n" % e)
```
...
# **mint_v0_aerodrome_slipstream_liquidity_provision_mint_post**
> UnsignedTransaction mint_v0_aerodrome_slipstream_liquidity_provision_mint_post(aerodrome_slipstream_mint_liquidity_provision_request)
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Open a new LP position
        api_response = api_instance.mint_v0_aerodrome_slipstream_liquidity_provision_mint_post(aerodrome_slipstream_mint_liquidity_provision_request)
        print("The response of AerodromeSlipstreamApi->mint_v0_aerodrome_slipstream_liquidity_provision_mint_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AerodromeSlipstreamApi->mint_v0_aerodrome_slipstream_liquidity_provision_mint_post: %s\n" % e)
```
...
# **sell_exactly_v0_aerodrome_slipstream_swap_sell_exactly_post**
> UnsignedTransaction sell_exactly_v0_aerodrome_slipstream_swap_sell_exactly_post(aerodrome_slipstream_sell_exactly_request)
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Swap - from specified amount
        api_response = api_instance.sell_exactly_v0_aerodrome_slipstream_swap_sell_exactly_post(aerodrome_slipstream_sell_exactly_request)
        print("The response of AerodromeSlipstreamApi->sell_exactly_v0_aerodrome_slipstream_swap_sell_exactly_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AerodromeSlipstreamApi->sell_exactly_v0_aerodrome_slipstream_swap_sell_exactly_post: %s\n" % e)
```
...
# **withdraw_v0_aerodrome_slipstream_liquidity_provision_withdraw_post**
> UnsignedTransaction withdraw_v0_aerodrome_slipstream_liquidity_provision_withdraw_post(aerodrome_slipstream_withdraw_liquidity_provision_request)
...
with compass.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Withdraw an LP position
        api_response = api_instance.withdraw_v0_aerodrome_slipstream_liquidity_provision_withdraw_post(aerodrome_slipstream_withdraw_liquidity_provision_request)
        print("The response of AerodromeSlipstreamApi->withdraw_v0_aerodrome_slipstream_liquidity_provision_withdraw_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AerodromeSlipstreamApi->withdraw_v0_aerodrome_slipstream_liquidity_provision_withdraw_post: %s\n" % e)
```
