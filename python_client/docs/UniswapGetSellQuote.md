...
json = "{}"
# create an instance of UniswapGetSellQuote from a JSON string
uniswap_get_sell_quote_instance = UniswapGetSellQuote.from_json(json)
# print the JSON string representation of the object
print(UniswapGetSellQuote.to_json())

# convert the object into a dict
uniswap_get_sell_quote_dict = uniswap_get_sell_quote_instance.to_dict()
# create an instance of UniswapGetSellQuote from a dict
uniswap_get_sell_quote_from_dict = UniswapGetSellQuote.from_dict(uniswap_get_sell_quote_dict)
```
