...
json = "{}"
# create an instance of IncreaseErc20AllowanceCallData from a JSON string
increase_erc20_allowance_call_data_instance = IncreaseErc20AllowanceCallData.from_json(json)
# print the JSON string representation of the object
print(IncreaseErc20AllowanceCallData.to_json())

# convert the object into a dict
increase_erc20_allowance_call_data_dict = increase_erc20_allowance_call_data_instance.to_dict()
# create an instance of IncreaseErc20AllowanceCallData from a dict
increase_erc20_allowance_call_data_from_dict = IncreaseErc20AllowanceCallData.from_dict(increase_erc20_allowance_call_data_dict)
```
