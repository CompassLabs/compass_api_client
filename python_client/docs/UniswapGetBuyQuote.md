...
json = "{}"
# create an instance of UniswapGetBuyQuote from a JSON string
uniswap_get_buy_quote_instance = UniswapGetBuyQuote.from_json(json)
# print the JSON string representation of the object
print(UniswapGetBuyQuote.to_json())

# convert the object into a dict
uniswap_get_buy_quote_dict = uniswap_get_buy_quote_instance.to_dict()
# create an instance of UniswapGetBuyQuote from a dict
uniswap_get_buy_quote_from_dict = UniswapGetBuyQuote.from_dict(uniswap_get_buy_quote_dict)
```
