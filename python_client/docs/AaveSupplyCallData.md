...
json = "{}"
# create an instance of AaveSupplyCallData from a JSON string
aave_supply_call_data_instance = AaveSupplyCallData.from_json(json)
# print the JSON string representation of the object
print(AaveSupplyCallData.to_json())

# convert the object into a dict
aave_supply_call_data_dict = aave_supply_call_data_instance.to_dict()
# create an instance of AaveSupplyCallData from a dict
aave_supply_call_data_from_dict = AaveSupplyCallData.from_dict(aave_supply_call_data_dict)
```
