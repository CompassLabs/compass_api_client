...
json = "{}"
# create an instance of TransferERC20TokenCallData from a JSON string
transfer_erc20_token_call_data_instance = TransferERC20TokenCallData.from_json(json)
# print the JSON string representation of the object
print(TransferERC20TokenCallData.to_json())

# convert the object into a dict
transfer_erc20_token_call_data_dict = transfer_erc20_token_call_data_instance.to_dict()
# create an instance of TransferERC20TokenCallData from a dict
transfer_erc20_token_call_data_from_dict = TransferERC20TokenCallData.from_dict(transfer_erc20_token_call_data_dict)
```
