...
```python
from compass.api_client.models.aero_swap_tokens_call_data import AeroSwapTokensCallData

# TODO update the JSON string below
json = "{}"
# create an instance of AeroSwapTokensCallData from a JSON string
aero_swap_tokens_call_data_instance = AeroSwapTokensCallData.from_json(json)
# print the JSON string representation of the object
print(AeroSwapTokensCallData.to_json())

# convert the object into a dict
aero_swap_tokens_call_data_dict = aero_swap_tokens_call_data_instance.to_dict()
# create an instance of AeroSwapTokensCallData from a dict
aero_swap_tokens_call_data_from_dict = AeroSwapTokensCallData.from_dict(aero_swap_tokens_call_data_dict)
```
