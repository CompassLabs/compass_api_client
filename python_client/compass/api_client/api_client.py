...
from compass.api_client.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = "OpenAPI-Generator/1.0.122/python"
    ...
    def call_api(
        ...
        if "x-compass-origin" not in header_params:
            header_params["x-compass-origin"] = "python SDK"
