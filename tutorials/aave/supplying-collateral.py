...
call_data = {"asset": asset, "amount": amount}
...
supply_collateral_query = BaseTransactionRequestAaveSupplyCallData.from_dict(payload)

try:
    response = aave_api.process_request_v0_aave_supply_post_with_http_info(supply_collateral_query)
